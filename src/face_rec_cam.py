...
def main():
    ...
    CLASSIFIER_PATH = 'Face_Detection/models/facemodel.pkl'
    VIDEO_PATH = args.path
    FACENET_MODEL_PATH = 'Face_Detection/models/20180402-114759.pb'
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            pnet, rnet, onet = align.detect_face.create_mtcnn(sess, "Face_Detection/src/align")
                    ...
                    if faces_found > 1:
                        ...
                        for i in range(faces_found):
                            ...
                            if (bb[i][3]-bb[i][1])/frame.shape[0]>0.25:
                                ...
                                print("Name: {}, Probability: {}, {}".format(best_name, best_class_probabilities, time_now))
                                ...
                                if best_class_probabilities > 0.8:
                                    ...
                                    if (cell_date is not None):
                                        if (worksheet_today.cell(cell_name.row, cell_date.col).value == "TRUE"):
                                            pass
                                        else:
